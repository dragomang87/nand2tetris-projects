...
(function_label.08_FunctionCalls_StaticsTest_Class1.vm.Class1.set)
@0
 D  = A
@SP
  M = M + D
...
// VM pop  static (static.08_FunctionCalls_StaticsTest_Class1.vm) 0
// ASM['pop stack'] (to D)
@SP
A M = M - 1
 D  = M
  M = 0             // optional safety feature
@static.08_FunctionCalls_StaticsTest_Class1.vm.0
  M = D
 D  = 0             // optional safety feature
// VM push argument 1
// A = argument + 1 = source
...
A   = A - 1
  M = D
 D  = 0             // optional safety feature
// VM pop  static (static.08_FunctionCalls_StaticsTest_Class1.vm) 1
// ASM['pop stack'] (to D)
@SP
A M = M - 1
 D  = M
  M = 0             // optional safety feature
@static.08_FunctionCalls_StaticsTest_Class1.vm.1
  M = D
 D  = 0             // optional safety feature
// VM push constant 0
// ASM['push value'](0)
...
(asm_delete_stack_label.08_FunctionCalls_StaticsTest_Class1.vm.instance_label_{ASM['instance_label_index']}.local)  // loop start
// ASM['delete stack']
@SP                 // optional safety feature
A M = M - 1         // optional safety feature
  M = 0             // optional safety feature
 D  = D - 1         // decrement counter
@asm_delete_stack_label.08_FunctionCalls_StaticsTest_Class1.vm.instance_label_{ASM['instance_label_index']}.local      // point to clearing
...
@SP                 // go to stack pointer
  M = M + 1         // add one entry to SP, one is always deleted
 D  = M - D         // turn D into a counter of entries to clear
(asm_delete_stack_label.08_FunctionCalls_StaticsTest_Class1.vm.instance_label_{ASM['instance_label_index']}.argument)  // loop start
// ASM['delete stack']
@SP                 // optional safety feature
A M = M - 1         // optional safety feature
  M = 0             // optional safety feature
 D  = D - 1         // decrement counter
@asm_delete_stack_label.08_FunctionCalls_StaticsTest_Class1.vm.instance_label_{ASM['instance_label_index']}.argument      // point to clearing
D; JGT              // loop jump if counter >= 1
// END   optional safety feature
//@SP               // Alternative unsafe code
//  M = D + 1       // Alternative unsafe code
...
(function_label.08_FunctionCalls_StaticsTest_Class1.vm.Class1.get)
@0
 D  = A
@SP
  M = M + D
// VM push static (static.08_FunctionCalls_StaticsTest_Class1.vm) 0
...
A   = A - 1
  M = D
 D  = 0             // optional safety feature
// VM push static (static.08_FunctionCalls_StaticsTest_Class1.vm) 1
// ASM['push ram']({static}.{i})
@{static}.{i}
 D  = M
// ASM['push stack'] (from D)
