...
class Syntacker():
    ...
    def parse_classVarDecs(self):
        ...
        while True:
            ...
            jack_class_variable += self.parse_variable_list(identifiers=self.code['globals'])
            for identifier in self.code['globals']:
                self.code['globals'][identifier] = (declaration_scope, )
    ...
    def parse_subroutineDecs(self):
        ...
        while True:
            ...
            self.code['subroutines'][identifier] = subroutine
    ...
    def parse_parameterDef(self):
        ...
        return jack_parameters, parameters
    ...
    def parse_variable_list(self, identifiers = {}):
        ...
        if token[0] == 'identifier':
            declaration += (token,)
            identifiers[token[1]] = declaration_type
        else:
            raise SyntaxError(
                    f"FAIL parsing token {token}: "
                    f"variable type "
